...
/**
 * <p>
 * This class handles the main functions of the admin
 * </p>
 * <p>
 * It is also initializes the building, the flats and the users
 * </p>
 */
...
public class Admin {
    ...
    public void updateMonthlyBalance(int nid, String date){
        ...
        this.createBalanceNotification(monthlyCosts, date, nid);
    }

    public void createNotification(int nid, String description, String date){
        Notification n = new Notification(nid, description, date);
        this.sendNotification(n);
    }

    public Notification createBalanceNotification(HashMap<Integer, Double> hashcost, String date, int nid) {
        String message = "";
        ...
        Notification nf = new Notification(nid, message, date);
