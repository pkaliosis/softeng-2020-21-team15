...
public class AdminTest {
    ...
    @Test
    public void testCreateBalanceNotification(){
        Notification temp = new Notification("description", "today");
        HashMap<Integer, Double> hm = new HashMap<>();
        hm.put(0, 20.0);
        hm.put(0, 40.0);
        Assert.assertEquals(temp.getNId(), admin.createBalanceNotification(hm, "today").getNId());
    }
}